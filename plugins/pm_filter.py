...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('💠 CHΛИИΞL 💠', url='https://t.me/malayali00l'),
            InlineKeyboardButton('💠 UᎮDΛTΞS 💠', url='https://t.me/MMCINEMACHAKKU')
            ],[      
            InlineKeyboardButton('♻️ HΞLᎮ ♻️', callback_data='help'),
            InlineKeyboardButton('𝙾𝚠𝚗𝚎𝚛', url='https://t.me/cinemaclubcc'),
            InlineKeyboardButton('♻️ ΛBOUT ♻️', callback_data='about')
            ],[
            InlineKeyboardButton('✅ SUBSCᏒIBΞ  ✅', url='https://t.me/MMCINEMACHAKKU')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)      
        await query.message.edit_text(
        ...
        buttons= [[
            InlineKeyboardButton('♥️ SԾUᏒCΞ ♥️', url='https://t.me/malayali00l')
            ],[
            InlineKeyboardButton('🏠 𝗛𝗼𝗺𝗲 🏠', callback_data='start'),
